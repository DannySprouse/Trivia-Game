$(document).ready(function () {
  ...
  var capitalGame = {
    ...
    imagesArrayCentral: [
      "<img class='img-ver' src='assets/images/central/mi.jpg' alt='State Capitol Building in Lansing, Michigan'>",
      "<img class='img-ver' src='assets/images/central/oh.jpg' alt='State Capitol Building in Columbus, Ohio'>",
      "<img class='img-ver' src='assets/images/central/in.jpg' alt='State Capitol Building in Indianapolis, Indiana'>",
      "<img class='img-ver' src='assets/images/central/wi.jpg' alt='State Capitol Building in Madison, Wisconsin'>",
      "<img class='img-ver' src='assets/images/central/il.jpg' alt='State Capitol Building in Springfield, Illinois'>",
      "<img class='img-ver' src='assets/images/central/mn.jpg' alt='State Capitol Building in St. Paul, Minnesota'>",
      "<img class='img-hor' src='assets/images/central/ia.jpg' alt='State Capitol Building in Des Moines, Iowa'>",
      "<img class='img-hor' src='assets/images/central/mo.jpg' alt='State Capitol Building in Jefferson City, Missouri'>",
      "<img class='img-hor' src='assets/images/central/ne.jpg' alt='State Capitol Building in Lincoln, Nebraska'>",
      "<img class='img-hor' src='assets/images/central/ks.jpg' alt='State Capitol Building in Topeka, Kansas'>",
      "<img class='img-hor' src='assets/images/central/ok.jpg' alt='State Capitol Building in Oklahoma City, Oklahoma'>",
      "<img class='img-hor' src='assets/images/central/tx.jpg' alt='State Capitol Building in Austin, Texas'>",
      "<img class='img-hor' src='assets/images/central/nd.jpg' alt='State Capitol Building in Bismarck, North Dakota'>",
      "<img class='img-hor' src='assets/images/central/sd.jpg' alt='State Capitol Building in Pierre, South Dakota'>"
    ],
