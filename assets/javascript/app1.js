$(document).ready(function () {
  ...
  var capitalGame = {
    ...
    imagesArrayNorth: [
      "<img class='img-ver' src='assets/images/northeast/me.jpg' alt='State Capitol Building in Augusta, Maine'>",
      "<img class='img-ver' src='assets/images/northeast/vt.jpg' alt='State Capitol Building in Montpelier, Vermont'>",
      "<img class='img-ver' src='assets/images/northeast/nh.JPG' alt='State Capitol Building in Concord, New Hampshire'>",
      "<img class='img-hor' src='assets/images/northeast/ny.JPG' alt='State Capitol Building in Albany, New York'>",
      "<img class='img-ver' src='assets/images/northeast/nj.jpg' alt='State Capitol Building in Trenton, New Jersey'>",
      "<img class='img-hor' src='assets/images/northeast/ma.jpg' alt='State Capitol Building in Boston, Massachusetts'>",
      "<img class='img-hor' src='assets/images/northeast/ct.jpg' alt='State Capitol Building in Hartford, Connecticut'>",
      "<img class='img-ver' src='assets/images/northeast/ri.jpg' alt='State Capitol Building in Providence, Rhode Island'>",
      "<img class='img-hor' src='assets/images/northeast/pa.JPG' alt='State Capitol Building in Harrisburg, Pennsylvania'>",
      "<img class='img-hor' src='assets/images/northeast/md.jpg' alt='State Capitol Building in Annapolis, Maryland'>",
      "<img class='img-ver' src='assets/images/northeast/de.jpg' alt='State Capitol Building in Dover, Delaware'>"
    ],
